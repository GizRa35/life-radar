...
const Map<String, String> _en = {
  ...
  'Toplanma alanını belirle': 'Identify an assembly point',
  'Aile iletişim planı yap': 'Make a family communication plan',
  'Sarsıntıda çök-kapan-tutun': 'Drop, cover and hold on during shaking',
  'Güvenliyse binadan çık': 'Exit the building if it is safe',
  'Gaz ve elektriği kapat': 'Turn off gas and electricity',
  'Resmi açıklamaları dinle': 'Follow official announcements',
  'Su': 'Water',
  'Konserve gıda': 'Canned food',
  'El feneri': 'Flashlight',
  'Düdük': 'Whistle',
  'Kanamayı baskı ile durdur': 'Stop bleeding by applying pressure',
  'Kırık şüphesinde hareket ettirme': 'Do not move if a fracture is suspected',
  'Bilinci kontrol et, gerekirse 112': 'Check consciousness, call 112 if needed',
  'Riskli bölgeyi öğren': 'Learn the at-risk areas',
  'Değerli evrakları yükselt': 'Move valuable documents to higher ground',
  'Tahliye rotası belirle': 'Plan an evacuation route',
  'Yüksek yere çık': 'Move to higher ground',
  'Sel sularına girme': 'Do not enter flood water',
  'Elektrikten uzak dur': 'Stay away from electricity',
  'Temiz su': 'Clean water',
  'Powerbank': 'Power bank',
  'Su geçirmez kılıf': 'Waterproof case',
  'İlk yardım': 'First aid',
  'Hipotermiye dikkat': 'Watch for hypothermia',
  'Yaraları temiz tut': 'Keep wounds clean',
  'Duman dedektörü tak': 'Install a smoke detector',
  'Yangın söndürücü bulundur': 'Keep a fire extinguisher handy',
  'Kaçış planı yap': 'Make an escape plan',
  'Eğilerek dumandan kaç': 'Stay low to escape smoke',
  'Kapı sıcaksa açma': 'Do not open a door if it is hot',
  "110'u ara": 'Call 110',
  'Yangın söndürücü': 'Fire extinguisher',
  'Islak bez': 'Wet cloth',
  'Yanığı soğuk suyla yıka': 'Rinse burns with cold water',
  'Su toplamış yanığı patlatma': 'Do not pop blistered burns',
  'El feneri ve powerbank hazırla': 'Prepare a flashlight and power bank',
  'Önemli cihazları şarj et': 'Charge important devices',
  'Buzdolabını az aç': 'Open the fridge as little as possible',
  'Mum yerine fener kullan': 'Use a flashlight instead of candles',
  'Piller': 'Batteries',
  'Radyo': 'Radio',
  'Tıbbi cihaz kullananlar için yedek güç planı':
      'Backup power plan for those using medical devices',
  'Birkaç günlük içme suyu depola': 'Store several days of drinking water',
  'Su tasarrufu alışkanlığı': 'Build water-saving habits',
  'Suyu önceliklendir (içme/temizlik)': 'Prioritize water (drinking/cleaning)',
  'Resmi duyuruyu izle': 'Follow official announcements',
  'Şişe su': 'Bottled water',
  'Islak mendil': 'Wet wipes',
  'Dezenfektan': 'Disinfectant',
  'Dehidrasyon belirtilerine dikkat': 'Watch for signs of dehydration',
  'Maske ve dezenfektan bulundur': 'Keep masks and disinfectant',
  'Aşıları güncel tut': 'Keep vaccinations up to date',
  'Belirti varsa izole ol': 'Isolate if you have symptoms',
  'Resmi rehbere uy': 'Follow official guidance',
  'Maske': 'Mask',
  'Ateş ölçer': 'Thermometer',
  'Temel ilaçlar': 'Basic medicines',
  'Ateş ve nefes darlığında sağlık kuruluşuna başvur':
      'See a healthcare provider for fever or shortness of breath',
  'Uyarıları takip et': 'Follow warnings',
  'Dış mekan eşyalarını sabitle': 'Secure outdoor items',
  'Kapalı alanda kal': 'Stay indoors',
  'Seyahati ertele': 'Postpone travel',
  'Battaniye': 'Blanket',
  'Hipotermi/sıcak çarpması belirtilerine dikkat':
      'Watch for hypothermia/heatstroke symptoms',
  'Diğer': 'Other',
